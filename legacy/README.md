...
> **Código legado.** Preservado sem alterações como referência de
> comportamento para a versão web (ver [`../docs/PLANO-WEB.md`](../docs/PLANO-WEB.md)
> e o teste de paridade em `../backend/tests/test_parity.py`). Os comandos
> abaixo devem ser executados a partir desta pasta (`cd legacy`).
